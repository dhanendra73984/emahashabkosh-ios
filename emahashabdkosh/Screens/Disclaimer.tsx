...
const Disclaimer = (props: any) => {
  ...
  const [error, setError] = useState<boolean>(false); // Error flag
      ...
      try {
        const apiUrl =
          selectedLanguage === 'English'
            ? 'https://lilaonmobile.rb-aai.in/emaha/Disclaimer.html'
            : 'https://lilaonmobile.rb-aai.in/emaha/HDisclaimer.html';
